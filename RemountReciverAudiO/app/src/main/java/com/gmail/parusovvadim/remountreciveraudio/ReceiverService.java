...
//        }
    ...
    public static class O {
        ...
        private static Notification buildNotification(Service context, String channelId) {
            ...
            return new Notification.Builder(context, channelId).setContentTitle("ARC")
                    .setContentText("Работает система управления АУДИ")
                    .setSmallIcon(R.mipmap.ic_launcher).setContentIntent(piLaunchMainActivity)
